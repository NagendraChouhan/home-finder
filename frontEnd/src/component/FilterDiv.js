        ...
        <div>
          <form onSubmit={handleOnSubmit}>
            ...
            <div className="form-div">
                ...
                <label>                <input type="radio" name="sortBy" value={formData.sortBy} onChange={handelOnChange}/>
                Price Low-High
                </label>
                <label>
                <input type="radio" name="sortBy" value={formData.sortBy} onChange={handelOnChange}/>
                Price High-Low
                </label>
            </div>
            <div className="button-div">
              <button style={filterFormButon} type="submit">Apply</button>
            </div>
          </form>
        </div>
